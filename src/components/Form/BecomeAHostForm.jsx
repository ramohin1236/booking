        ...
        <div className='flex justify-center mt-6'>
          <div className='w-full max-w-md p-8 space-y-3 text-gray-800 rounded-xl bg-gray-50'>
            ...
            >
              ...
              <button
                type='submit'
                className='block w-full p-3 bg-blue-500 hover:bg-blue-800 text-white text-center font-medium tracking-wide  transition duration-200  focus:shadow-outline focus:outline-none rounded-md'
              >
                Submit Request
              </button>
            </form>
