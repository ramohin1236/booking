...
const AddServiceForm = ({handleSubmit,arrivalDate,setArrivalDate,departureDate,
setDepartureDate}) => {
    return (
        <>
      <div className='flex justify-center mt-6'>
        <div className='w-full max-w-md p-8 space-y-3 text-gray-800 rounded-xl bg-gray-50'>
          ...
          >
            ...
            <button
              type='submit'
              className='block w-full p-3 text-center font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-gradient-to-r bg-blue-500 hover:bg-blue-800 focus:shadow-outline focus:outline-none'
            >
              Save & Continue
            </button>
          </form>
